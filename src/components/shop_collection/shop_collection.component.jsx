...
// class ShopCollection1 extends React.Component {
...
// export default withRouter(connect(mapStateToProps)(ShopCollection1));


const ShopCollection = React.memo(({ title, routeName, items }) => {
	const match = useRouteMatch();
	const collection = useSelector(URLDeducedCollectionSelector(match.params.collection));
